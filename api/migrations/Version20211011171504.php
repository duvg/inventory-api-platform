 ...
 */
final class Version20211011171504 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create `group_request` table';
    }
    ...
    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE `group_request` (
            ...
            CONSTRAINT FK_group_request_group_id FOREIGN KEY (group_id) REFERENCES `user_groups` (id) ON UPDATE CASCADE ON DELETE CASCADE ,
