 ...
 */
final class Version20211008050248 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Creates `user_groups`, `user_group_user` tables and its relationship';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user_group_users`(
                ...
                CONSTRAINT FK_user_group_group_user_id FOREIGN KEY (group_id) REFERENCES `user_groups` (id) ON UPDATE CASCADE ON DELETE CASCADE                               
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE InnoDB'
        );
