...
use App\Exception\Movement\CannotUseThisCategoryMovementInMovementException;
...
class MovementPreWriteListener implements PreWriteListener
{
    ...
    public function onKernelView(ViewEvent $event): void
    {
        ...
        if (in_array($request->get('_route'), [self::MOVEMENT_POST, self::MOVEMENT_PUT])) {
            ...
            if (null !== $group = $movement->getGroup()) {
                ...
                if (!$movement->getCategoryMovement()->belongsToGroup($group)) {
                    throw new CannotUseThisCategoryMovementInMovementException();
                }
            }
            ...
            if (!$movement->getCategoryMovement()->isOwnedBy($tokenUser)) {
                throw new CannotUseThisCategoryMovementInMovementException();
            }
        }
    }
